...
void H_LCD_void_Init(void)
{
	...
	//set direction D3 .. D0
	MDIO_voidSetPinDirection(LCD_D3_PORT,LCD_D3_PIN,OUT_2MHZ_PP);
	MDIO_voidSetPinDirection(LCD_D2_PORT,LCD_D2_PIN,OUT_2MHZ_PP);
	MDIO_voidSetPinDirection(LCD_D1_PORT,LCD_D1_PIN,OUT_2MHZ_PP);
	MDIO_voidSetPinDirection(LCD_D0_PORT,LCD_D0_PIN,OUT_2MHZ_PP);
#endif
...
static void H_LCD_void_writeNlatch(u8 copy_u8Byte)
{
  ...
  // step 1 : prepare Data (D7 .. D0)
	MDIO_voidSetPinValue(LCD_D0_PORT ,LCD_D0_PIN  , GET_BIT(copy_u8Byte,0));
	MDIO_voidSetPinValue(LCD_D1_PORT ,LCD_D1_PIN  , GET_BIT(copy_u8Byte,1));
	MDIO_voidSetPinValue(LCD_D2_PORT ,LCD_D2_PIN  , GET_BIT(copy_u8Byte,2));
	MDIO_voidSetPinValue(LCD_D3_PORT ,LCD_D3_PIN  , GET_BIT(copy_u8Byte,3));
